...
#assume {pc == 0}
assert {(!reset) && instruction[31:26] == 6'b000000 && instruction[5:0] == 6'b100000 |-> ##2  $past(result) == (registers[$past(rs)]) + (registers[$past(rt)]) && pc == $past(pc) + 4} 
assert {(!reset) && instruction[31:26] == 6'b000000 && instruction[5:0] == 6'b100000 |-> ##2  registers[$past(rd)] == $past(result) && pc == $past(pc) + 4}
